...
class Room(aioxmpp.im.conversation.AbstractConversation):
    ...
    .. signal:: on_muc_stale(**kwargs)
        ...
        Often, the MUC service is on a remote domain, which means that there are
        at least two network connections involved, sometimes three (c2s, s2s,
        and from the remote server to the MUC component).
